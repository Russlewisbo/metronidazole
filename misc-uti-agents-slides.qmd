...
subtitle: "Pharmacology that decides clinical fate"
...
format:
  revealjs:
    ...
    slide-number: true
    transition: fade
    logo: misc-uti-agents-images/DMM_newlogo.png
...
- Half-life ~8 h; hepatic oxidation is the main route (active **hydroxy metabolite**)
...
- Emerging data support **twice-daily** as non-inferior to thrice-daily for many indications
